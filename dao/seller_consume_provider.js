...
SellerConsumeRecordProvider = function() {
...
SellerConsumeRecordProvider.prototype.getCollection = function(callback) {
	this.connector.collection('seller_consume_record' , function(error , repertory_collection){
		if(error)
		     callback(error);
		else 
...
SellerConsumeRecordProvider.prototype.findAll = function(callback) {
...
SellerConsumeRecordProvider.prototype.save = function(repertorys , callback) {
	this.getCollection(function(error , repertory_collection){
		if(error) {
		   callback(error);
		} else {
...
SellerConsumeRecordProvider.prototype.pagedAll = function(startIndex , pageSize ,  orderPop , callback) {
	this.getCollection(function(error , repertory_collection) {
		if(error) {
		     callback(error);
		} else {
...
SellerConsumeRecordProvider.prototype.deleteById = function(id , callback) {
...
exports.SellerConsumeRecordProvider = SellerConsumeRecordProvider;
